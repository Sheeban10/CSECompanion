...
class AssignmentMarks2Admin: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_assignment_marks2_admin)
    ...
    private fun setDataToFields() {
        ...
        val ref = FirebaseDatabase.getInstance().getReference("/Assignments/Assignment 2/$uid")
