...
class MstMarksUploadAdmin : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mst_marks_upload_admin)
    ...
    private fun setDataToFields() {
        ...
        val ref = FirebaseDatabase.getInstance().getReference("/MST Marks/MST 1/$uid")
