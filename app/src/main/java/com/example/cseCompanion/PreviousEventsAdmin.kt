...
import kotlinx.android.synthetic.main.activity_previous_events_admin.*
import kotlinx.android.synthetic.main.activity_upload_notice_admin.*
import kotlinx.android.synthetic.main.activity_upload_notice_admin.addImage
import kotlinx.android.synthetic.main.activity_upload_notice_admin.noticeImageView
import kotlinx.android.synthetic.main.activity_upload_notice_admin.noticeTitle
import kotlinx.android.synthetic.main.activity_upload_notice_admin.progressBar
import kotlinx.android.synthetic.main.activity_upload_notice_admin.uploadNoticeButton
...
class PreviousEventsAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_previous_events_admin)
    ...
    private fun uploadImage() {
        ...
        val ref = FirebaseStorage.getInstance().getReference("/upcomingEvents/$filename")
    ...
    private fun saveDataToFirebaseRealtimeDatabase(imageUrl: String) {
        ...
        val ref =  FirebaseDatabase.getInstance().getReference("/upcomingEvents").push()
