...
import kotlinx.android.synthetic.main.activity_update_tt6_c3.*
import kotlinx.android.synthetic.main.activity_upload_notice_admin.progressBar
import java.util.*

@Suppress("DEPRECATION")
class UpdateTt6C3Admin: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_update_tt6_c3)

        title = "Time Table 6C3"

        addImageTt3.setOnClickListener {
            openGallery()
        }

        uploadTt3Button.setOnClickListener {
