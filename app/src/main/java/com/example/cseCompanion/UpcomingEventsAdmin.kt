...
import kotlinx.android.synthetic.main.activity_upcoming_events_admin.*
...
class UpcomingEventsAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_upcoming_events_admin)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == pickImage && resultCode == RESULT_OK){
            imageUri = data?.data
            upcoming_events_id.setImageURI(imageUri)
        }
    }
}
