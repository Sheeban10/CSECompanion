...
class MarksMst3Admin : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_marks_mst3_admin)
    ...
    private fun setDataToFields() {
        ...
        val ref = FirebaseDatabase.getInstance().getReference("/MST Marks/MST 3/$uid")
