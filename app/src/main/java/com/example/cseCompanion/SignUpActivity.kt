...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun signUpUser(){
        ...
        if (signUp_college_roll_no.text.toString().isEmpty()){
            signUp_college_roll_no.error = "Please enter college roll no."
            signUp_college_roll_no.requestFocus()
            return
        }
    ...
    private fun saveUserToFirebaseDatabase() {
        ...
        val user = UserData(uid,signUp_name.text.toString(),signUp_college_roll_no.text.toString(),signUp_email.text.toString())
...
class UserData(val uid:String, val username: String, val collRollNo: String, val email: String)