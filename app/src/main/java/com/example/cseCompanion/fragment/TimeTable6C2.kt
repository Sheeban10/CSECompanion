...
import kotlinx.android.synthetic.main.fragment_time_table6_c2.*
import kotlinx.android.synthetic.main.fragment_time_table6_c2.pic_6c2
import kotlinx.android.synthetic.main.fragment_time_table6_c3.*
import kotlinx.android.synthetic.main.notice_board_row.view.*
import java.io.File
import java.lang.Exception


class TimeTable6C2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View =  inflater.inflate(R.layout.fragment_time_table6_c2, container, false)
        val ref = FirebaseDatabase.getInstance().getReference("8C2")
        ref.get().addOnSuccessListener {
            Log.d("pic",it.toString())
            val uri = it.value.toString()
            Picasso.get().load(uri).into(pic_6c2 , object : Callback{
                override fun onSuccess() {
                    progressBar_timetable2.visibility = View.GONE
                }
