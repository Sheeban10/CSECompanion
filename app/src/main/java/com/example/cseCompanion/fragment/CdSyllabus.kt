...
import kotlinx.android.synthetic.main.fragment_cd_syllabus.view.*
import kotlinx.android.synthetic.main.fragment_pdf_web_view.view.*
import java.io.File


class CdSyllabus : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View =  inflater.inflate(R.layout.fragment_cd_syllabus, container, false)
        val fileRef = FirebaseStorage.getInstance().getReference("/syllabus/syllabus.pdf")

        val localFile = File.createTempFile("cdSyllabus", ".pdf")
        fileRef.getFile(localFile)
            .addOnSuccessListener {
                view.cd_pfdView.fromFile(localFile)
                    .pages(58,59)
                    .load()
                view.cd_progressBar.visibility = View.GONE
